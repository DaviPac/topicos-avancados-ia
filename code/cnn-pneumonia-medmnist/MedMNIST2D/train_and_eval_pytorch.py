...
from models import ResNet18, ResNet18Slim, ResNet50
...
def main(data_flag, output_root, num_epochs, gpu_ids, batch_size, size, download, model_flag, resize, as_rgb, model_path, run):
    ...
    elif model_flag == 'resnet18slim':  # MODIFICACAO (trabalho): arquitetura proposta
        model = ResNet18Slim(in_channels=n_channels, num_classes=n_classes)
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_flag',
                        default='resnet18',
                        help='choose backbone from resnet18, resnet50, resnet18slim',
                        type=str)
